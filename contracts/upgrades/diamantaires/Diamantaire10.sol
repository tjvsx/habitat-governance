...
contract Diamantaire10 {
  ...
  bytes4 internal immutable _selector5;
  bytes4 internal immutable _selector6;
  bytes4 internal immutable _selector7;
  bytes4 internal immutable _selector8;
  bytes4 internal immutable _selector9;
  ...
  constructor(IDiamondCuttable.FacetCut[] memory _facetCuts) {
    ...
    for (uint256 i; i < _facetCuts.length; i++) { 
      ...
      _selector5 = facetCut.selectors[5];
      _selector6 = facetCut.selectors[6];
      _selector7 = facetCut.selectors[7];
      _selector8 = facetCut.selectors[8];
      _selector9 = facetCut.selectors[9];
    }
  }
  ...
  function execute(uint _proposalId) external {
    ...
    bytes4[] memory _selectors = new bytes4[](10);
    _selectors[0] = _selector0;
    _selectors[1] = _selector1;
    _selectors[2] = _selector2;
    _selectors[3] = _selector3;
    _selectors[4] = _selector4;
    _selectors[5] = _selector5;
    _selectors[6] = _selector6;
    _selectors[7] = _selector7;
    _selectors[8] = _selector8;
    _selectors[9] = _selector9;
